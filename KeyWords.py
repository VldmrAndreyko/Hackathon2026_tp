class KeyWords:
    SPAM_KEY_WORDS = [
        "http", "выиграть", "выигрыш", "скидка", "розыгрыш", "приз",
        "акция", "купить", "цена", "выгода", "казино", "доход"]

    URGENT_KEY_WORDS = [
        "срочно", "экстренно", "быстро", "авария", "ошибка",
        "проблема", "упасть", "лежать", "сломаться", "критический",
        "недоступен", "отключить", "взлом", "вирус"]
